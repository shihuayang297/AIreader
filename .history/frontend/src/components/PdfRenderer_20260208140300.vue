...
const emit = defineEmits(['loaded', 'create-annotation', 'delete-annotation', 'outline-loaded', 'ai-ask', 'ai-action', 'page-change', 'update-annotation'])
...
// 2. 使用交互处理
const { activePopover, handleMouseUp, handleHighlightClick, bubbleMenu, hideBubbleMenu } = usePdfInteraction(props, emit, pdfContentRef, pdfContainer)

const onBubbleAiAction = (payload) => {
  hideBubbleMenu()
